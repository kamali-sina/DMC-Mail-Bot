"""
Programmed by Sina Kamali and Behzad Shayeq at Univercity of Tehran. You can contact us at sininoir@gmail.com or behzad.shayegh@ut.ac.ir .
...
class Server :
    def __init__(self, Email, password, attachments_path='./received_attachments/', log_path='./mails_log/',testmode = False):
        """
        Inputs:
        Email: the email to listen on, String
        password: the password of the email, String
        attachments_path: the path to store recieved attachments, String
        log_path: the path to store log files, String
        testmode: if we are in testing mode or final mode, Bool
        """
        #configurations
...
s = Server('gmail to listen on', 'your passwords')
s.listen()
